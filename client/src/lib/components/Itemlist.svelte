		...
		<div class="item relative">
			...
			>
				...
				<span class="absolute right-0 px-3 z-10 bg-blue-100">
					<span on:click={() => _move(idx, -1)}><i class="fa fa-angle-up " /></span>
					<span on:click={() => _move(idx, 1)} class="px-2"><i class="fa fa-angle-down" /> </span>
					<span on:click={() => edit(idx)}><i class="fa fa-edit pointer-events-auto" /></span>
